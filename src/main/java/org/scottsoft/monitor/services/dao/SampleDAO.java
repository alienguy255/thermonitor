...
public abstract class SampleDAO<T extends ISampleRrdDb, S> implements ISampleDAO<S> {
    ...
    @Override
    public List<S> getSamples(String id, Date fromTime, Date toTime) {
    ...
    @Override
    public void insertSample(String id, RrdSample rrdSample) {
    ...
    protected abstract S convertSample(String id, RrdSample rrdSample);
    ...
    protected abstract String getRrdDbFilePath(String id);
