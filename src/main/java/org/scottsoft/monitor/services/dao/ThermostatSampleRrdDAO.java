...
import org.scottsoft.monitor.domain.sample.ThermostatSample;
...
public class ThermostatSampleRrdDAO extends SampleDAO<ThermostatSampleRrdDb, IThermostatSample> {
    ...
    @Override
    protected String getRrdDbFilePath(String thermostatId) {
    ...
    @Override
    protected IThermostatSample convertSample(String thermostatId, RrdSample rrdSample) {
