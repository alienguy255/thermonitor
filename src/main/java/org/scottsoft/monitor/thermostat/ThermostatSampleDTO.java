...
public record ThermostatSampleDTO(Double currentTemp, Double targetTemp, Double tstate, Long timeMs) {

    public ThermostatSampleDTO(Double currentTemp, Double targetTemp, Double tstate, Long timeMs) {
